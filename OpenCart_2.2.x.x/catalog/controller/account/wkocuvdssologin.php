...
class ControllerAccountWkocuvdssologin extends Controller
{
    ...
    public function index()
    {
        ...
        if ($this->customer->isLogged()) {
            ...
            $this->response->redirect($this->url->link('account/wkocuvdssologin/authorize', 'client_id=' . $this->request->get['client_id'] . '&redirect_url=' . $this->request->get['redirect_url'] . '&cancel_url=' . $appdetails['cancel_url'], true));
        }
        ...
        $data['action'] = $this->url->link('account/wkocuvdssologin', $url, true);
        ...
        $this->response->setOutput($this->load->view('account/wkocuvdssologin', $data));
    }
